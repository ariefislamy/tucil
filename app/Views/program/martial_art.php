...
<div class="card-group">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Member kelas bela diri selama 1 tahun, dengan waktu yang bisa disesuaikan dengan pelatih.</p>
      <p><strong>Rp.5.500.000</strong></p>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Member kelas bela diri selama 1 bulan, dengan waktu yang bisa disesuaikan dengan pelatih.</p>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Member kelas bela diri hanya 1 hari, dengan waktu yang bisa disesuaikan dengan pelatih.</p>
