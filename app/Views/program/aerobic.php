...
<div class="card-group">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Member Aerobic selama 1 tahun, dengan waktu yang bisa disesuaikan dengan instruktur.</p>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Member Aerobic selama 1 bulan, dengan waktu yang bisa disesuaikan dengan instruktur.</p>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">Member Aerobic hanya 1 hari, dengan waktu yang bisa disesuaikan dengan instruktur.</p>
